...
class FoodTypesService extends Controller
{
    ...
    {
        return config('views.rows.food-types-service');
    }
    ...
    {
        return [
            ["title" => __("Food Type Info"), "id" => "food-type-info", "status" => "active", "icon" => "fas fa-circle-info"],
        ];
    }
